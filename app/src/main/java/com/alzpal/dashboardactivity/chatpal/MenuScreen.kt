...
fun MenuScreen(
    ...
    Surface(
        color = Color(0xFFFFFFF0), // Light beige color for background
        ...
        LazyColumn(
            ...
            items(menuItems) { menuItem ->
                Card(
                    colors = CardDefaults.cardColors(containerColor = Color(0xFFE61069)), // Pink color for card
                    modifier = Modifier
                        .fillMaxWidth()
                    ...
                    Column(
                        ...
                        TextButton(
                            ...
                            Text(
                                ...
                                color = Color.White // Set button text color to white
                            )
                        }
                    }
                }
